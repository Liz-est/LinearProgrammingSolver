...
bool EigenFactor::factorize(const ::lp_solver::util::PackedMatrix& basis_matrix) {
...
void EigenFactor::ftran(::lp_solver::util::IndexedVector& rhs) const {
    if (!is_factorized_) {
...
void EigenFactor::btran(::lp_solver::util::IndexedVector& rhs) const {
    if (!is_factorized_) {
...
void EigenFactor::updateEta(int pivot_row, const ::lp_solver::util::IndexedVector& ftran_col) {
